...
const Hero = () => {
  ...
  return (
    <section className='max-w-screen-xl flex flex-col gap-4 md:flex-row md:items-center pt-16 md:pt-28 pb-20 px-6 mx-auto' id='hero'>
      ...
      <div className='flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]'>
        <div className='w-[430px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-950 p-6'>
          ...
          <div className='bg-cardbg rounded-md text-center mt-3 p-4'>
            ...
            <p className='text-slate-800 text-xs md:font-medium mt-1'>{jobTitle}</p>
          ...
          <InfoTile icon={<FiMail size={20} className='text-cyan-400' />}
            text={email}
          />

          <InfoTile icon={<MdOutlineBadge size={20} className='text-cyan-400'
           />}
