  ...
  return (
    <section
      ...
      id='experience'>
        ...
        <h5 className='text-primary text-2xl md:text-3xl font-semibold text-center pb-14 md:pb-4'>Past Projects</h5>
...
const WorkExperienceCard = ({
  ...
  return (
    <div className='relative'>
      ...
      {!isLast && (
        <div className='hidden md:block min-w-96 h-[140px] border-r border-b border-cyan-500 border-dashed' />
      )}
      ...
      <div className='bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-800/40 p-4 mx-0 md:mx-10 md:absolute top-[70px] mb-6 md:mb-0'>
        <div className='flex items-center justify-between flex-1'>
          <div>
            ...
            <span className='text-cyan-500 text-xs'>{position}</span>
          </div>
        ...
        <p className='text-cyan-100 text-xs font-normal leading-5 mt-5'>{description}</p>
      </div>
    </div>
  );
};
